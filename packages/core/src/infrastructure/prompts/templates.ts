...
- start_agent_task - Spawn an autonomous agent to work independently on complex tasks (research, multi-step builds, code generation). The agent runs until completion with its own tool access.
